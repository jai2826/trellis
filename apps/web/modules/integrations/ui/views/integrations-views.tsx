        ...
        <div className="mx-auto w-full max-w-screen-md">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Choose the integrations that&apos;s right for
              you
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-sm">
                Add the following code to your website to
                enable the chatbox.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {INTEGRATIONS.map((item) => (
                <button
                  key={item.id}
                  onClick={() =>
                    handleIntegrationClick(item.id)
                  }
                  type="button"
    ...
    <Dialog
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Follow these steps to add the chatbox to your
            website
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="rounded-md bg-accent p-2 text-sm">
              2. Add the following script to your website
            </div>
            <p className="text-muted-foreground text-sm">
              Paste the chatbox code above in your page. You
              can add it in the HTML head section.
            </p>
          </div>
        </div>
      </DialogContent>
